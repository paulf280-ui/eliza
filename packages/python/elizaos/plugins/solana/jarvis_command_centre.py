...
async def _cmd_free_chat(text: str, runtime: AgentRuntime) -> str:
    ...
    system_prompt = (
        ...
        "'Risk check' → exposure analysis:\n"
        "  Wallet: X SOL | In positions: X SOL (X% deployed)\n"
        "  Largest position: X% of wallet — flag if >20%\n"
        "  Max drawdown today: -X% | Narrative/DEX concentration\n"
        "  Copy-trade wallet loss windows: any paused wallets?\n"
